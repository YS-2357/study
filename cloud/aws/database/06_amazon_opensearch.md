...
If a support-ticket draft assistant used OpenSearch directly instead of [Knowledge Bases](../../ai/concepts/03_amazon_bedrock_knowledge_bases.md), the `generate_draft` Lambda would look like this:
...
[Knowledge Bases](../../ai/concepts/03_amazon_bedrock_knowledge_bases.md) is the managed alternative: lower control, lower operational burden. Choose OpenSearch when you need custom hybrid search, metadata pre-filtering, or full pipeline control.
...
**Related:** [Amazon Redshift](./05_amazon_redshift.md), [Knowledge Bases](../../ai/concepts/03_amazon_bedrock_knowledge_bases.md)
**Tags:** #aws #database
