...
boto3 is the official [AWS](../../101/service/00_overview.md) SDK for Python. It lets Python code call any AWS service API — creating S3 buckets, reading DynamoDB items, invoking Bedrock models — without manually signing HTTP requests.
...
| `"bedrock-runtime"` | [Amazon Bedrock](04_amazon_bedrock.md) inference |
...
---
← Previous: [AWS Lambda](09_aws_lambda.md) | [Overview](aws/201/service/00_overview.md) | Next: [Amazon API Gateway](10_amazon_api_gateway.md) →
