...
|---|---|
| **[S3](../../101/aws_services/19_amazon_s3.md)** | Documents in a bucket (PDF, TXT, HTML, CSV, MD, DOC, XLS) |
...
Without RAG, models can only use their training data — they hallucinate when asked about your specific content. Knowledge Bases provides managed RAG so your [agents](06_amazon_bedrock_agents.md) and applications give answers grounded in your actual documents, with citations pointing back to the source.
