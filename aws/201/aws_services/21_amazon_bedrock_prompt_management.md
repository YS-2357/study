...
Prompts can be referenced by [Flows](20_amazon_bedrock_flows.md) nodes and [Agents](06_amazon_bedrock_agents.md) instruction fields, or invoked directly via the `bedrock-agent` API:
