...
- Protocols, Addressing → [Security Group](../cloud/aws/identity/02_security_group.md) (protocol + port rules)
- CIDR, Subnets → [Subnet](../cloud/aws/foundation/05_subnet.md), [VPC](../cloud/aws/foundation/04_amazon_vpc.md)
- HTTP → [ELB](../cloud/aws/networking/01_elastic_load_balancing.md) (ALB routes HTTP traffic)
- DNS → [VPC](../cloud/aws/foundation/04_amazon_vpc.md) (VPC DNS settings)
