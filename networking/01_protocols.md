...
Used for Linux server administration. See [EC2](../cloud/aws/compute/01_amazon_ec2.md) for AWS-specific SSH usage.
...
Used for Windows server administration. See [EC2](../cloud/aws/compute/01_amazon_ec2.md) for AWS-specific RDP usage.
...
Protocols determine which ports to open in [Security Groups](../cloud/aws/identity/02_security_group.md), which [load balancer](../cloud/aws/networking/01_elastic_load_balancing.md) type to use (NLB for TCP/UDP, ALB for HTTP), and how to troubleshoot connectivity issues.

---
↑ [Overview](./00_networking_overview.md)

**Related:** [Addressing](02_addressing.md), [HTTP](05_http.md), [EC2](../cloud/aws/compute/01_amazon_ec2.md), [Security Groups](../cloud/aws/identity/02_security_group.md), [load balancer](../cloud/aws/networking/01_elastic_load_balancing.md)
**Tags:** #networking
