...
Used for Linux server administration. See [EC2](../aws/101/aws_services/05_amazon_ec2.md) for AWS-specific SSH usage.
...
Used for Windows server administration. See [EC2](../aws/101/aws_services/05_amazon_ec2.md) for AWS-specific RDP usage.
