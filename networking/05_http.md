...
HTTP is the foundation of [ALB](../aws/101/aws_services/16_elastic_load_balancing.md) routing (path-based, host-based), [API Gateway](../aws/101/aws_services/07_aws_lambda.md) design, and [CloudFront](../aws/101/aws_services/21_amazon_cloudfront.md) caching. Understanding status codes is essential for debugging production issues.
