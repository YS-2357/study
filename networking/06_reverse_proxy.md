...
For HTTP fundamentals used by reverse proxies, see [HTTP](05_http.md). For load balancing as a specific reverse proxy use case, see [ELB](../aws/networking/01_elastic_load_balancing.md).
