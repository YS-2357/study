...
AWS reserves 5 IPs per [subnet](../aws/101/aws_services/03_subnet.md) (first 4 + last 1), so a /24 subnet has 251 usable IPs.
...
Controlled by inbound/outbound rules in [Security Groups](../aws/101/aws_services/14_security_group.md).

## Example

A typical AWS [VPC](../aws/101/aws_services/04_amazon_vpc.md) setup:
