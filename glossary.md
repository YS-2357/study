...
| ELB  | Elastic Load Balancing              | AWS service family (ALB, NLB, GWLB) that distributes incoming traffic across targets.                                                            | [note](aws/networking/01_elastic_load_balancing.md)         |
...
| SDK  | Software Development Kit            | A library and toolset that lets code interact with a platform's API (e.g. boto3 for AWS).                                                        | [note](aws/devtools/02_boto3.md)                          |
