...
### DNS Caching
- See [DNS](../networking/04_dns.md) for full explanation
...
- **ElastiCache** — Managed Redis/Memcached/Valkey (see [ElastiCache](../aws/101/aws_services/13_amazon_elasticache.md))
