...
- Virtualization → [EC2](../aws/101/aws_services/05_amazon_ec2.md), [Lambda](../aws/101/aws_services/07_aws_lambda.md)
- Storage → [EBS](../aws/101/aws_services/20_amazon_ebs.md), [S3](../aws/101/aws_services/19_amazon_s3.md)

---

**Note:** These are general computing concepts. For AWS-specific implementations, see the main `aws/101/aws_services/` folder.
