...
**Cross-reference:**
- See [EC2 Storage](../aws_services_kiro/05_amazon_ec2.md#configure-storage) for AWS-specific storage configuration
- See [EBS](../aws_services_kiro/10_amazon_ebs.md) for detailed EBS documentation (when created)
