...
**See [Networking Basics - Addressing](../networking_kiro/02_addressing.md#cidr-classless-inter-domain-routing) for detailed explanation.**
...
**See [Networking Basics - Addressing](../networking_kiro/02_addressing.md#ip-addressing) for IPv4/IPv6 fundamentals.**
...
### IPv4 vs IPv6
**See [Networking Basics - Addressing](../networking_kiro/02_addressing.md#ip-addressing) for detailed explanation.**
...
**See [Networking Basics - Protocols](../networking_kiro/01_protocols.md) for protocol/port fundamentals.**
